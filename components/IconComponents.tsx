...
export const BriefcaseIcon = () => (
  <svg {...iconProps}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.92a2.25 2.25 0 01-2.25-2.25v-4.07m16.5 0a2.25 2.25 0 00-2.25-2.25H5.92a2.25 2.25 0 00-2.25 2.25m16.5 0v-1.875a2.25 2.25 0 00-2.25-2.25H5.92a2.25 2.25 0 00-2.25 2.25v1.875" /></svg>
);
...
export const UsersIcon = () => (
  <svg {...iconProps}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8q4.5-5 9 0t9 0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12q4.5-5 9 0t9 0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16q4.5-5 9 0t9 0" />
  </svg>
);

export const IdentificationIcon = () => (
    <svg {...iconProps}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 2h8a2 2 0 012 2v16a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17 3l4 4-9 9-4-1 1-4 8-8z" />
    </svg>
);

export const UserGroupIcon = () => (
    <svg {...iconProps}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.752 11.168l-3.197-2.132A1 1 0 0010.748 9.04v-2.015a1 1 0 00-1.5-1.5H6.25a1 1 0 00-1 1V15c0 .552.448 1 1 1h2.5a1 1 0 001-1v-2.015a1 1 0 00-.752-1.956l-1.996-.333m12.33 6.002l-3.197-2.132A1 1 0 0018.748 15.04v-2.015a1 1 0 00-1.5-1.5h-2.5a1 1 0 00-1 1V21c0 .552.448 1 1 1h2.5a1 1 0 001-1v-2.015a1 1 0 00-.752-1.956l-1.996-.333" />
    </svg>
);

export const AcademicCapIcon = () => (
    <svg {...iconProps}><path d="M12 14l9-5-9-5-9 5 9 5z" /><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" /></svg>
);
...
export const BrainIcon = () => (
    <svg {...iconProps}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.572L16.5 21.75l-.398-1.178a3.375 3.375 0 00-2.312-2.312L12 17.25l1.178-.398a3.375 3.375 0 002.312-2.312L16.5 13.5l.398 1.178a3.375 3.375 0 002.312 2.312L20.25 18l-1.178.398a3.375 3.375 0 00-2.312 2.312z" /></svg>
);
...
export const PuzzlePieceIcon = () => (
    <svg {...iconProps}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14L5 19" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l7 5" />
    </svg>
);